...
-   Swimming speed is reduced as environmental temperature diverges from thermal optima, reflecting empirical performance curves and diminished locomotor efficiency at suboptimal temperatures.

-   Agents calculate the energy expenditure associated with thermoregulation, with increased metabolic cost arising from reduced swimming efficiency under thermal stress.
...
**Note:** Using this function in combination with scaled metabolic efficiency will penalize the agent twice for temperature. Users should apply one or the other depending on model objectives, or use the metabolism function without efficiency scaling.
...
+-------------------+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------------+
| $\lambda$         | 0.01–0.05 (user-defined) \| Acclimation rate controls speed of physiological adjustment | Population variation where older fish are better at thermoregulating  |
+-------------------+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------------+
